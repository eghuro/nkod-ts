...
const publicHost = debug ? 'http://localhost:2992' : 'https://crawlcheck.io';
...
module.exports = {
  ...
  output: {
    path: path.join(__dirname, 'tsa', 'static', 'build'),
  ...
  plugins: [
    ...
    new ManifestRevisionPlugin(path.join(__dirname, 'tsa', 'webpack', 'manifest.json'), {
      rootAssetPath,
      ignorePaths: ['/js', '/css'],
    }),
  ].concat(debug ? [] : [
